...
**작성 구조**:
- 첫 문장: [포지션명] [주요 역할].
- 본문: 핵심 업무 + 기대 성과 → 요구 경력 수준 → 담당 프로젝트
- 마지막: 핵심 역할 재강조
...
**작성 구조**:
- 첫 문장: [필수 기술 3-5개]. [필수 역량].
- 본문: 필수 기술 스택 + 숙련도 요구 → Soft skills → 우대 기술
- 마지막: 기술 요구사항 재강조
...
**작성 구조**:
- 첫 문장: [제공하는 성장 기회]. [지원 체계].
- 본문: 학습 기회 + 도전 과제 → 멘토링 체계 → 경력 발전 경로
- 마지막: 성장 지원 재강조
...
**작성 구조**:
- 첫 문장: [핵심 가치]. [조직 문화].
- 본문: 핵심 가치관 → 업무 문화 → 문제 해결 방식 → 커뮤니케이션 스타일
- 마지막: 문화 특성 재강조
